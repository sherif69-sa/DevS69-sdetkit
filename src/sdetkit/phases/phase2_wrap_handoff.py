"""Compatibility wrapper for historical `sdetkit.phases.phase2_wrap_handoff` imports."""
...
_TARGET = _export_module("sdetkit.phases.release_readiness_wrap_handoff", globals())
