...
_CYCLE1_SUMMARY_PATH = "docs/artifacts/continuous-upgrade-cycle1-closeout-pack/continuous-upgrade-cycle1-closeout-summary.json"
_CYCLE1_BOARD_PATH = "docs/artifacts/continuous-upgrade-cycle1-closeout-pack/continuous-upgrade-cycle1-delivery-board.md"
...
_REQUIRED_COMMANDS = [
    ...
    "python scripts/check_continuous_upgrade_cycle2_contract.py",
]
_EXECUTION_COMMANDS = [
    "python -m sdetkit continuous-upgrade-cycle2-closeout --format json --strict",
    "python -m sdetkit continuous-upgrade-cycle2-closeout --emit-pack-dir docs/artifacts/continuous-upgrade-cycle2-closeout-pack --format json --strict",
    "python scripts/check_continuous_upgrade_cycle2_contract.py --skip-evidence",
]
