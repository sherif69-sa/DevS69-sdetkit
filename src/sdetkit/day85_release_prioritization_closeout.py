...
_DAY84_LEGACY_SUMMARY_PATH = "docs/artifacts/day84-evidence-narrative-closeout-pack/day84-evidence-narrative-closeout-summary.json"
_DAY84_LEGACY_BOARD_PATH = "docs/artifacts/day84-evidence-narrative-closeout-pack/day84-delivery-board.md"
...
def build_day85_release_prioritization_closeout_summary(root: Path) -> dict[str, Any]:
    ...
    day84_summary = _resolve_with_legacy(root, _DAY84_SUMMARY_PATH, _DAY84_LEGACY_SUMMARY_PATH)
    day84_board = _resolve_with_legacy(root, _DAY84_BOARD_PATH, _DAY84_LEGACY_BOARD_PATH)
