...
def build_continuous_upgrade_closeout_summary(root: Path) -> dict[str, Any]:
    ...
    if score >= 85 and strict:
        wins.append(f"Cycle 10 continuity baseline is stable with activation score={score}.")
    else:
    ...
    if not plan_hygiene_issues:
        ...
        handoff_actions.append(
            "Fix contributors/upgrade_channels list shapes and confidence_floor/cadence_interval bounds in docs/roadmap/plans/continuous-upgrade-plan-10.json."
        )
