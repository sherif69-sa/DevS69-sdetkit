...
_PREV_CYCLE_SUMMARY_PATH = "docs/artifacts/continuous-upgrade-cycle8-closeout-pack/continuous-upgrade-cycle8-closeout-summary.json"
_PREV_CYCLE_BOARD_PATH = "docs/artifacts/continuous-upgrade-cycle8-closeout-pack/continuous-upgrade-cycle8-delivery-board.md"
...
_REQUIRED_COMMANDS = [
    ...
    "python scripts/check_continuous_upgrade_cycle9_contract.py",
]
_EXECUTION_COMMANDS = [
    "python -m sdetkit continuous-upgrade-cycle9-closeout --format json --strict",
    "python -m sdetkit continuous-upgrade-cycle9-closeout --emit-pack-dir docs/artifacts/continuous-upgrade-cycle9-closeout-pack --format json --strict",
    "python scripts/check_continuous_upgrade_cycle9_contract.py --skip-evidence",
]
