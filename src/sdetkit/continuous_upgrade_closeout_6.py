...
def build_continuous_upgrade_closeout_summary(root: Path) -> dict[str, Any]:
    ...
    checks: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "evidence": {"board_items": board_count, "contains": board_has_cycle5},
        },
        {
    ...
    if not plan_hygiene_issues:
        ...
        handoff_actions.append(
            "Fix contributors/upgrade_channels list shapes and confidence_floor/cadence_interval bounds in docs/roadmap/plans/continuous-upgrade-plan-6.json."
        )
