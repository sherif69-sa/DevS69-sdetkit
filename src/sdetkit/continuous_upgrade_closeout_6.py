...
def build_continuous_upgrade_cycle6_closeout_summary(root: Path) -> dict[str, Any]:
    ...
    checks: list[dict[str, Any]] = [
        {
            ...
            "weight": 5,
            "passed": ("continuous-upgrade-closeout-6" in readme_text),
        ...
        },
        {
            ...
            "weight": 8,
            "passed": (
                "integrations-continuous-upgrade-closeout-6.md" in docs_index_text
                and "continuous-upgrade-closeout-6-summary.json" in docs_index_text
            ),
            "evidence": "integrations-continuous-upgrade-closeout-6.md",
        },
        {
    ...
    return {
        "name": "continuous-upgrade-closeout-6",
        "inputs": {
            "readme": "README.md",
...
def _emit_pack(root: Path, pack_dir: Path, payload: dict[str, Any]) -> None:
    ...
    _write(
        target / "continuous-upgrade-closeout-6-summary.json",
        json.dumps(payload, indent=2) + "\n",
    )
    _write(target / "continuous-upgrade-closeout-6-summary.md", _render_text(payload) + "\n")
    _write(
...
def main(argv: list[str] | None = None) -> int:
    ...
    if ns.execute:
        evidence_dir = (
            ...
            if ns.evidence_dir
            else Path("docs/artifacts/continuous-upgrade-closeout-6-pack/evidence")
        )
