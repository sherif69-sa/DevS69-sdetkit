...
- `docs/artifacts/continuous-upgrade-completion-pack-10/continuous-upgrade-completion-summary-10.json`
- `docs/artifacts/continuous-upgrade-completion-pack-10/continuous-upgrade-delivery-board-10.md`
- `docs/roadmap/plans/continuous-upgrade-plan-11.json`

## Lane command lane

```bash
python -m sdetkit continuous-upgrade-completion-11 --format json --strict
python -m sdetkit continuous-upgrade-completion-11 --emit-pack-dir docs/artifacts/continuous-upgrade-completion-11-pack --format json --strict
python -m sdetkit continuous-upgrade-completion-11 --execute --evidence-dir docs/artifacts/continuous-upgrade-completion-11-pack/evidence --format json --strict
