...
| Roadmap control panels | [Product roadmap](roadmap/product-roadmap.md), [Current product delta](current-product-delta.md), [Platform capability matrix](contracts/platform-capability-matrix.v1.json), [Reviewed KPI evidence contract](contracts/adoption-product-kpi-evidence.v1.json), [Remediation research contract](contracts/remediation-research.v1.json), [Remediation research guide](remediation-research-contract.md), [Formatter candidate benchmark](formatter-candidate-benchmark.md), [Formatter verifier and trajectory proof](formatter-verifier-trajectory-proof.md), [Curated advanced docs material map](orphan-docs-material-map.md), [Artifact reference](artifact-reference.md) | Use maintained product-control contracts, benchmark evidence, and verifier/trajectory evidence to choose focused slices; do not let generated trackers, candidate reports, or unreviewed metrics replace product direction. |
