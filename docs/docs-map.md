...
| Product direction | [Product roadmap](roadmap/product-roadmap.md), [Current product delta](current-product-delta.md), [Platform capability matrix](contracts/platform-capability-matrix.v1.json), [Reviewed KPI evidence contract](contracts/adoption-product-kpi-evidence.v1.json), [Remediation research contract](contracts/remediation-research.v1.json), [Remediation research guide](remediation-research-contract.md), [Formatter candidate benchmark](formatter-candidate-benchmark.md), [Formatter verifier and trajectory proof](formatter-verifier-trajectory-proof.md), [Formatter policy proposal eligibility](formatter-policy-proposal.md), [Formatter policy proposal observation](formatter-policy-proposal-observation.md) | Use the roadmap for execution order, the delta for released-versus-main truth, the matrix for implemented capabilities and gaps, the KPI contract for reviewed product measurements, the remediation contract for review-first candidate evidence, the benchmark guide for disposable formatter evaluation, and the verifier guide for read-only evidence composition. Keep these secondary to the operator path. |
| Maintenance / autopilot | [Artifact reference](artifact-reference.md#maintenance-autopilot-upload-set), [Operations handbook](operations-handbook.md), [Automation bots](automation-bots.md), [Remediation research guide](remediation-research-contract.md), [Formatter candidate benchmark](formatter-candidate-benchmark.md), [Formatter verifier and trajectory proof](formatter-verifier-trajectory-proof.md), [Formatter policy proposal eligibility](formatter-policy-proposal.md), [Formatter policy proposal observation](formatter-policy-proposal-observation.md) | Treat plans, candidates, safe-fix outputs, benchmark outputs, verifier outputs, trajectories, memory profiles, and remediation-research reports as evidence until reviewed policy approves the next step. |
...
| Roadmap control panels | [Product roadmap](roadmap/product-roadmap.md), [Current product delta](current-product-delta.md), [Platform capability matrix](contracts/platform-capability-matrix.v1.json), [Reviewed KPI evidence contract](contracts/adoption-product-kpi-evidence.v1.json), [Remediation research contract](contracts/remediation-research.v1.json), [Remediation research guide](remediation-research-contract.md), [Formatter candidate benchmark](formatter-candidate-benchmark.md), [Formatter verifier and trajectory proof](formatter-verifier-trajectory-proof.md), [Formatter policy proposal eligibility](formatter-policy-proposal.md), [Formatter policy proposal observation](formatter-policy-proposal-observation.md), [Curated advanced docs material map](orphan-docs-material-map.md), [Artifact reference](artifact-reference.md) | Use maintained product-control contracts, benchmark evidence, and verifier/trajectory evidence to choose focused slices; do not let generated trackers, candidate reports, or unreviewed metrics replace product direction. |
