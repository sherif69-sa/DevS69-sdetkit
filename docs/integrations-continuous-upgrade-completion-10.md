...
- `docs/artifacts/continuous-upgrade-completion-pack-9/continuous-upgrade-completion-summary-9.json`
- `docs/artifacts/continuous-upgrade-completion-pack-9/continuous-upgrade-delivery-board-9.md`
- `docs/roadmap/plans/continuous-upgrade-plan-10.json`

## Lane command lane

```bash
python -m sdetkit continuous-upgrade-completion-10 --format json --strict
python -m sdetkit continuous-upgrade-completion-10 --emit-pack-dir docs/artifacts/continuous-upgrade-completion-10-pack --format json --strict
python -m sdetkit continuous-upgrade-completion-10 --execute --evidence-dir docs/artifacts/continuous-upgrade-completion-10-pack/evidence --format json --strict
