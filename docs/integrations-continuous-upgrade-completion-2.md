...
## Why Continuous Upgrade Lane Completion matters
...
- `docs/artifacts/continuous-upgrade-completion-pack-1/continuous-upgrade-completion-summary-1.json`
- `docs/artifacts/continuous-upgrade-completion-pack-1/continuous-upgrade-delivery-board-1.md`
- `docs/roadmap/plans/continuous-upgrade-plan-2.json`

## Command lane

```bash
python -m sdetkit continuous-upgrade-completion-2 --format json --strict
python -m sdetkit continuous-upgrade-completion-2 --emit-pack-dir docs/artifacts/continuous-upgrade-completion-2-pack --format json --strict
python -m sdetkit continuous-upgrade-completion-2 --execute --evidence-dir docs/artifacts/continuous-upgrade-completion-2-pack/evidence --format json --strict
