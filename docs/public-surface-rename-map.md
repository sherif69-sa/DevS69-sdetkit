# Public surface rename map

This map defines the current canonical public names and the compatibility aliases that remain callable during transition.
...
Legacy aliases remain callable for compatibility, but the root CLI help and playbooks catalog should prefer canonical names.
Historical docs, historical artifact directories, and legacy module filenames remain in place until the later archive/structure cleanup phases.
