...
- New `case-study-prep2-completion` CLI lane with strict scoring and Cycle 69 continuity validation.
...
- New `docs/roadmap/plans/cycle70-triage-speed-case-study.json` baseline dataset scaffold for triage-speed case-study prep.
