...
| --- | --- | --- | --- | --- |
| 15 | GitHub Actions integration quickstart | `docs/name-15-ultra-upgrade-report.md` | `docs/artifacts/cycle15-github-actions-quickstart-sample.md` | shipped ✅ |
| 16 | GitLab CI integration quickstart | `docs/name-16-ultra-upgrade-report.md` | `docs/artifacts/cycle16-gitlab-ci-quickstart-sample.md` | shipped ✅ |
