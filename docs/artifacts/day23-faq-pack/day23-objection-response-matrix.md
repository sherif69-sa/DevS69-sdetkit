...
| How do we prove readiness? | Emit Name 23 FAQ pack and attach evidence summary in release review. | `python -m sdetkit objection-handling --emit-pack-dir docs/artifacts/day23-faq-pack --format json --strict` |
