...
`ARCHITECTURE.md`, `WORKFLOW.md`, `QUALITY_PLAYBOOK.md`, and `ENTERPRISE_OFFERINGS.md` remain as short root pointers because existing checks and external links may still look for those paths.
