...
- New `cycle78-ecosystem-priorities-closeout` CLI lane with strict scoring and Cycle 77 continuity validation.
...
- New `docs/roadmap/plans/ecosystem-priorities-plan.json` baseline dataset scaffold for ecosystem execution planning.

### Command lane

```bash
python -m sdetkit cycle78-ecosystem-priorities-closeout --format json --strict
python -m sdetkit cycle78-ecosystem-priorities-closeout --emit-pack-dir docs/artifacts/cycle78-ecosystem-priorities-closeout-pack --format json --strict
python -m sdetkit cycle78-ecosystem-priorities-closeout --execute --evidence-dir docs/artifacts/cycle78-ecosystem-priorities-closeout-pack/evidence --format json --strict
