...
- New `case-study-prep1-closeout` CLI lane with strict scoring and Day 68 continuity validation.
...
- New `docs/roadmap/plans/reliability-case-study.json` baseline dataset scaffold for reliability case-study prep.
