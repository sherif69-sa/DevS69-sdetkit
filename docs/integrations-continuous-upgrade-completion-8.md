...
- `docs/artifacts/continuous-upgrade-completion-pack-7/continuous-upgrade-completion-summary-7.json`
- `docs/artifacts/continuous-upgrade-completion-pack-7/continuous-upgrade-delivery-board-7.md`
