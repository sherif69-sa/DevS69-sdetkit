...
- `docs/artifacts/continuous-upgrade-completion-pack-6/continuous-upgrade-completion-summary-6.json`
- `docs/artifacts/continuous-upgrade-completion-pack-6/continuous-upgrade-delivery-board-6.md`
- `docs/roadmap/plans/continuous-upgrade-plan-7.json`

## Lane command lane

```bash
python -m sdetkit continuous-upgrade-completion-7 --format json --strict
python -m sdetkit continuous-upgrade-completion-7 --emit-pack-dir docs/artifacts/continuous-upgrade-completion-7-pack --format json --strict
python -m sdetkit continuous-upgrade-completion-7 --execute --evidence-dir docs/artifacts/continuous-upgrade-completion-7-pack/evidence --format json --strict
