...
- `docs/artifacts/continuous-upgrade-completion-pack-8/continuous-upgrade-completion-summary-8.json`
- `docs/artifacts/continuous-upgrade-completion-pack-8/continuous-upgrade-delivery-board-8.md`
- `docs/roadmap/plans/continuous-upgrade-plan-9.json`

## Lane command lane

```bash
python -m sdetkit continuous-upgrade-completion-9 --format json --strict
python -m sdetkit continuous-upgrade-completion-9 --emit-pack-dir docs/artifacts/continuous-upgrade-completion-9-pack --format json --strict
python -m sdetkit continuous-upgrade-completion-9 --execute --evidence-dir docs/artifacts/continuous-upgrade-completion-9-pack/evidence --format json --strict
