...
- `docs/artifacts/continuous-upgrade-completion-pack-5/continuous-upgrade-completion-summary-5.json`
- `docs/artifacts/continuous-upgrade-completion-pack-5/continuous-upgrade-delivery-board-5.md`
