...
- `docs/artifacts/continuous-upgrade-completion-pack-4/continuous-upgrade-completion-summary-4.json`
- `docs/artifacts/continuous-upgrade-completion-pack-4/continuous-upgrade-delivery-board-4.md`
- `docs/roadmap/plans/continuous-upgrade-plan-5.json`

## Lane command lane

```bash
python -m sdetkit continuous-upgrade-completion-5 --format json --strict
python -m sdetkit continuous-upgrade-completion-5 --emit-pack-dir docs/artifacts/continuous-upgrade-completion-5-pack --format json --strict
python -m sdetkit continuous-upgrade-completion-5 --execute --evidence-dir docs/artifacts/continuous-upgrade-completion-5-pack/evidence --format json --strict
