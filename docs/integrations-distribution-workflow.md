...
python -m sdetkit distribution-completion --emit-pack-dir docs/artifacts/distribution-completion-pack --format json --strict
python -m sdetkit distribution-completion --execute --evidence-dir docs/artifacts/distribution-completion-pack/evidence --format json --strict
python scripts/check_distribution_completion_contract.py
```
