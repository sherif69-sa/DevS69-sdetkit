...
# flow-order-anchor: phase5-ecosystem-contract
...
format-before-proof: venv
	@bash -lc '. .venv/bin/activate && python -m sdetkit.format_before_proof --root .'

proof-after-format: format-before-proof
	@bash -lc '. .venv/bin/activate && python -m pre_commit run -a'
