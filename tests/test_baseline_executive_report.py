...
from scripts import baseline_executive_report as report
...
def test_build_report() -> None:
    out = report.build_report(
        ...
        {"ready_for_release readiness": False, "next_step": "make baseline-followup-pass"},
...
def test_main_writes_outputs(tmp_path: Path) -> None:
    ...
    _write(gate, {"ready_for_release readiness": False, "next_step": "make baseline-next"})
