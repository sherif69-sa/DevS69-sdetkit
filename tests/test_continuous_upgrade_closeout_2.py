...
from sdetkit import continuous_upgrade_closeout_2 as c2
...
def _seed_repo(root: Path) -> None:
    ...
    plan = root / "docs/roadmap/plans/continuous-upgrade-plan-2.json"
    plan.write_text(
        json.dumps(
            {
...
def test_strict_fails_without_cycle1(tmp_path: Path) -> None:
    _seed_repo(tmp_path)
    (
        tmp_path
        / "docs/artifacts/continuous-upgrade-closeout-pack-1/continuous-upgrade-closeout-summary-1.json"
