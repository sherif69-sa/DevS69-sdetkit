...
def test_cycle1_json(tmp_path: Path, capsys) -> None:
    ...
    assert out["name"] == "continuous-upgrade-closeout-1"
...
def test_cycle1_emit_pack_and_execute(tmp_path: Path) -> None:
    ...
    rc = c1.main(
        [
            ...
            str(tmp_path),
            "--emit-pack-dir",
            "artifacts/continuous-upgrade-closeout-1-pack",
            "--execute",
            "--evidence-dir",
            "artifacts/continuous-upgrade-closeout-1-pack/evidence",
            "--format",
            "json",
            "--strict",
        ]
    ...
    assert (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/continuous-upgrade-closeout-1-summary.json"
    ).exists()
    assert (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/continuous-upgrade-closeout-1-summary.md"
    ).exists()
    assert (
        tmp_path
    ...
    assert (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/continuous-upgrade-cycle1-upgrade-template-upgrade-ledger.json"
    ).exists()
    assert (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/continuous-upgrade-cycle1-storyline-outcomes-ledger.json"
    ).exists()
    assert (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/continuous-upgrade-cycle1-upgrade-kpi-scorecard.json"
    ).exists()
    assert (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/continuous-upgrade-cycle1-execution-log.md"
    ).exists()
    assert (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/continuous-upgrade-cycle1-delivery-board.md"
    ).exists()
    assert (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/continuous-upgrade-cycle1-validation-commands.md"
    ).exists()
    execution_summary = (
        tmp_path
        / "artifacts/continuous-upgrade-closeout-1-pack/evidence/cycle1-execution-summary.json"
    )
