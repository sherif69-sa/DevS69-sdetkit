...
from scripts import baseline_telemetry_history as telemetry
    ...
    entry = telemetry.build_history_entry(
        {
            "ok": False,
            "steps": [
                {"command": "make baseline-baseline", "ok": False, "duration_ms": 12},
                {"command": "make baseline-status", "ok": True, "duration_ms": 8},
            ],
        }
    )
