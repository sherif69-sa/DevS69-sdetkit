...
from scripts import phase1_completion_and_prune_plan as workflow
...
def test_prunes_phase1_and_advances(tmp_path: Path) -> None:
    ...
    result = workflow.phase1(status, plan, archive)
