...
ANCHORS = [
    ...
    "kpi deep audit",
    "platform readiness wrap publication",
    "platform readiness kickoff",
    "platform readiness preplan",
    "release readiness wrap handoff",
...
EXACT_TOP10 = [
    ...
    "release-readiness-wrap-handoff",
    "release-readiness-hardening",
    "release readiness wrap handoff and platform readiness kickoff strategy chain",
    "platform readiness preplan + release readiness hardening strategy chain",
    "Platform Readiness Wrap Publication strategy chain",
    "Platform Readiness Kickoff strategy chain",
    "Platform Readiness Preplan strategy chain",
    "Release Readiness Wrap Handoff strategy chain",
    "Release Readiness Hardening strategy chain",
    "phase2-hardening",
