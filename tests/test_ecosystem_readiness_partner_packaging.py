...
def test_ecosystem_readiness_partner_packaging_incomplete_when_missing_artifacts() -> None:
    payload = {
...
def test_ecosystem_readiness_partner_packaging_missing_required_keys_fails() -> None:
