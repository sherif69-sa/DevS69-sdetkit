...
class Text(JupyterMixin):
    ...
    def markup(self) -> str:
        ...
        return serialize_text_markup(self)
    ...
    def from_markup(
        ...
        *,
        ...
        rendered_text.no_wrap = no_wrap
        rendered_text.end = end
        rendered_text.tab_size = tab_size
    ...
    def divide(self, offsets: Iterable[int]) -> Lines:
        ...
        fragment_sequence = FragmentSequence.from_offsets(_offsets, text_length=text_length)
        line_ranges = fragment_sequence.line_ranges
        ...
        _Text = Text
        new_lines = Lines(
            make_fragment(self, text[start:end], is_last=fragment_sequence[index].is_last)
        ...
        _Span = Span
        distributor = SpanDistributor(line_ranges)

        for line_no, fragments in enumerate(distributor.distribute(self._spans)):
            for fragment in fragments:
                _line_appends[line_no](_Span(fragment.start, fragment.end, fragment.style))
