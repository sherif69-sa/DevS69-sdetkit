...
from sdetkit import scale_closeout_44 as d43


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate scale closeout contract.")
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/scale-closeout-pack/evidence/scale-execution-summary.json"
