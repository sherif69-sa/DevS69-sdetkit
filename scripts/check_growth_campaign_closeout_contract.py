...
from sdetkit import day81_growth_campaign_closeout as lane

_CANONICAL_EVIDENCE = "docs/artifacts/growth-campaign-closeout-pack/evidence/growth-campaign-execution-summary.json"
_LEGACY_EVIDENCE = "docs/artifacts/day81-growth-campaign-closeout-pack/evidence/day81-execution-summary.json"


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate growth-campaign-closeout contract")
    ...
    if errors:
        print("growth-campaign-closeout contract check failed:", file=sys.stderr)
        for error in errors:
            print(f"- {error}", file=sys.stderr)
        return 1

    print("growth-campaign-closeout contract check passed")
    return 0
