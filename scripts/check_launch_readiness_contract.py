...
from sdetkit import launch_readiness as lane
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate launch-readiness-closeout contract")
    ...
    if errors:
        print("launch-readiness-closeout contract check failed:", file=sys.stderr)
        for error in errors:
            print(f"- {error}", file=sys.stderr)
        return 1

    print("launch-readiness-closeout contract check passed")
    return 0
