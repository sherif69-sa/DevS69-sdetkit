...
def main() -> int:
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/case-study-prep1-closeout-pack/evidence/case-study-prep1-execution-summary.json"
        )
    ...
    if errors:
        print("case-study-prep1-closeout contract check failed:", file=sys.stderr)
        for err in errors:
            print(f"- {err}", file=sys.stderr)
        return 1

    print("case-study-prep1-closeout contract check passed")
    return 0
