...
_LEGACY_EVIDENCE = "docs/artifacts/day85-release-prioritization-closeout-pack/evidence/day85-execution-summary.json"
...
def main() -> int:
    ...
    if errors:
        print("release-prioritization-closeout contract check failed:", file=sys.stderr)
        for error in errors:
            print(f"- {error}", file=sys.stderr)
        return 1

    print("release-prioritization-closeout contract check passed")
    return 0
