#!/usr/bin/env python3
"""Validate baseline baseline summary contract payload."""
...
def main() -> int:
    ...
    if not exists:
        ...
        if ns.format == "json":
            ...
            print("baseline-summary-contract: FAIL")
    ...
    if ns.format == "json":
        ...
        print(
            "baseline-summary-contract: OK" if payload["ok"] else "baseline-summary-contract: FAIL"
        )
        for row in checks:
