...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Day 78 ecosystem priorities closeout contract")
    ...
    if not ns.skip_evidence:
        evidence = root / "docs/artifacts/day78-ecosystem-priorities-closeout-pack/evidence/day78-execution-summary.json"
