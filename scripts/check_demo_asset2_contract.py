...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate demo asset #2 contract.")
    ...
    if not ns.skip_evidence:
        evidence = (
            root / "docs/artifacts/demo-asset2-pack/evidence/demo-asset2-execution-summary.json"
        )
