#!/usr/bin/env python3
"""Emit baseline status report: accomplished vs pending."""
...
def main() -> int:
    ...
    ap.add_argument("--summary", default="build/baseline/baseline-summary.json")
    ...
    result = {
        "ok": done,
        "schema_version": "sdetkit.baseline_status.v1",
    ...
    if ns.format == "json":
        ...
        print("baseline-status: COMPLETE" if done else "baseline-status: INCOMPLETE")
        print("accomplished:")
