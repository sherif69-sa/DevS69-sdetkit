...
from sdetkit import weekly_review_foundation as d28


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate weekly review contract.")
    ...
    if not ns.skip_evidence:
        evidence = (
            root / "docs/artifacts/weekly-review-pack/evidence/weekly-review-execution-summary.json"
        )
