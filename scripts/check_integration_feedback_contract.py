...
from sdetkit import integration_feedback as lane
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate integration-feedback-closeout contract")
    ...
    if errors:
        print("integration-feedback-closeout contract check failed:", file=sys.stderr)
        for error in errors:
            print(f"- {error}", file=sys.stderr)
        return 1

    print("integration-feedback-closeout contract check passed")
    return 0
