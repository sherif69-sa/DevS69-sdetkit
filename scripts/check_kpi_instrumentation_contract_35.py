...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate KPI instrumentation contract.")
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/kpi-instrumentation-pack/evidence/kpi-instrumentation-execution-summary.json"
        )
