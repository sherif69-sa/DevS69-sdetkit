...
def _evidence_candidates(root: Path) -> tuple[Path, Path]:
    return (
        root / "docs/artifacts/phase1-wrap-pack/evidence/phase1-wrap-execution-summary.json",
        root / "docs/artifacts/day30-wrap-pack/evidence/day30-execution-summary.json",
    )
