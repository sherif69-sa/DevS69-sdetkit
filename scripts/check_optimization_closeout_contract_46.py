...
from sdetkit import optimization_closeout_46 as d46


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate optimization closeout contract.")
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/optimization-closeout-pack/evidence/optimization-execution-summary.json"
        )
