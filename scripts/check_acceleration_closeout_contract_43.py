...
from sdetkit import acceleration_closeout_43 as d43


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate acceleration closeout contract.")
    ...
    if not ns.skip_evidence:
        evidence = (
            root
            / "docs/artifacts/acceleration-closeout-pack/evidence/day43-execution-summary.json"
        )
